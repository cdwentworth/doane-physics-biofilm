...
# Waiting
#from utilities import getListOfIterates, unzipfiles, getBulkData
...
def plotTime(type):
    ...
    else if strcmp(type,'biomass') || strcmp(type,'biomass_split')
    ...
    else if strcmp(type,'simpsonIndex') || strcmp(type,'simpsonIndex_noeps'):
